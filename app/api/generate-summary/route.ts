  ...
  try {
    ...
    for (let i = 0; i < apiKeys.length; i++) {
      ...
      try {
        ...
        const prompt = `Aşağıdaki haberi Türkçe özetle. Özet KISA ve ÖZ olmalı - maksimum 2-3 cümle veya 250 karakter ile sınırlı. Sadece en önemli ana fikri belirt. Cümleyi yarıda kesme, anlam bütünlüğünü koru. Sadece özet metnini yaz, "Özet:", "Başlık:" gibi etiketler ekleme:\n\n${content}`;
